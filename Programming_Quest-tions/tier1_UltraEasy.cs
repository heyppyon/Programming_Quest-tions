...
{
    public class tier1_UltraEasy
    {
        public void UltraEasy()
        {
            int opcion; do
            {   Console.WriteLine("PROGRAMMING QUESTIONS - ULTRA EASY QUESTIONS\n\n\n[ 1 ] - Print out your name in the screen.\n\n[ 2 ] - Count down from 700 to 200 in decrements of 3.\n\n" +
                ...
                switch (opcion)
                {
                    ...
                    case 6: //6.- Using the modolus operator, label all the even and odd numbers from 0-100. Do it again without the modulus operator.
                        ...
                        for (int i = 1; i <= 100; i++) { } //@ A @ <( sigo sin saber!!! )
                        fin(); break;
                    ...
                    case 9: //9.- Generate three random integers, each between 0-20. Fin the largest, smallest, and average of the three.
                        int large = 0, average = 0, small = 0; Random azar = new Random(); a = azar.Next(0, 20); int b = azar.Next(0, 20); int c = azar.Next(0, 20);
                        if (a > b && a > c) { large = a; } else if ((a > b && a < c) || (a < b && a > c)) { average = a; } else if (a < b && a < c) { small = a; }
                        if (b > a && b > c) { large = b; } else if ((b > a && b < c) || (b < a && b > c)) { average = b; } else if (b < a && b < c) { small = b; }
                        if (c > b && c > b) { large = c; } else if ((c > b && c < a) || (c < b && c > a)) { average = c; } else if (c < a && c < b) { small = c; }
